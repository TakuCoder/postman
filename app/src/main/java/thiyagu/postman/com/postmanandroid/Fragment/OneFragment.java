...
import thiyagu.postman.com.postmanandroid.ParamPopUp;
...
//{
//
//    String Item = getActivity().getIntent().getExtras().getString("deleteid");
//
//    refreshview();
//
//}
...
//        }
    ...
    public void RefereshView()
    {
        ...
        ArrayList<String> dataa = feedReaderDbHelper.getAllCotacts();
