...
public class HistoryMultiAdapter extends ExpandableRecyclerAdapter<HistoryCategoryViewHolder, HistoryViewHolder> {
...
//    CollectionDatabase collectionDatabase;
    ...
    public HistoryMultiAdapter(Context mcontext, List<? extends ParentListItem> parentItemList, String s) {
    ...
    @Override
    public HistoryCategoryViewHolder onCreateParentViewHolder(ViewGroup parentViewGroup) {
        View movieCategoryView = mInflator.inflate(R.layout.collection_layout, parentViewGroup, false);
        return new HistoryCategoryViewHolder(movieCategoryView, context);
    }
    ...
    public HistoryViewHolder onCreateChildViewHolder(ViewGroup childViewGroup) {
        ...
        return new HistoryViewHolder(moviesView);
    }

    @Override
    public void onBindParentViewHolder(HistoryCategoryViewHolder collectionCategoryViewHolder, int position, ParentListItem parentListItem) {
        MovieCategory movieCategory = (MovieCategory) parentListItem;
        collectionCategoryViewHolder.bind(movieCategory);
    }

    @Override
    public void onBindChildViewHolder(HistoryViewHolder collectionViewHolder, final int position, Object childListItem)
    {
...
class HistoryCategoryViewHolder extends ParentViewHolder {
    int i = 0;
    ...
    public HistoryCategoryViewHolder(View itemView, Context context) {
        super(itemView);
